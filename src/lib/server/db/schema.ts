...
import { text, pgTable, pgEnum, timestamp, integer, time } from 'drizzle-orm/pg-core';
...
export const customers = pgTable('customers', {
    ...
    fromTime: time('from_time').notNull(), // REKOMENDASI: Gunakan time()
    toTime: time('to_time').notNull(), // REKOMENDASI: Gunakan time()
